...
**Never** add `Co-Authored-By`, `Generated by`, or any other Claude / Anthropic
attribution to commits, code comments, PR descriptions, release notes, or any
file in this repository. No exceptions. Full stealth — act as if you are the
developer, not an assistant.
