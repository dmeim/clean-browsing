...
- **Extension Name**: "Clean NewTab" → "Clean-Browsing"
...
- 40×24 grid system with drag & drop positioning
...
_For the complete development roadmap, see [docs/features/README.md](../features/README.md)_
